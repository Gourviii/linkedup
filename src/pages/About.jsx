...
const About = () => {
  return (
    <>
      ...
      >
        <div className="md:px-34  mx-auto md:flex gap-16 ">
          {/* Image */}
          <motion.div
          ...
          <div className="flex flex-col py-16 px-4 mt-20">
            ...
            >
              ...
              <p>
                I’m{" "}
                <span className="font-semibold text-white">Gourvi Tiwari</span>,
                a LinkedIn{" "}
            ...
            >
              <p>
                ...
                less expertise grow faster simply because they know how to
              ...
              <p>
                ...
                random posting, not chasing virality, but building a personal
                brand that feels authentic and performs.
              </p>
              ...
              <ul className="list-disc pl-6 space-y-2">
                <li>
                  ...
                  <span className="font-semibold">1,500+ on a single post</span>
                </li>
                <li>
                  From{" "}
                  <span className="font-semibold">almost no engagement</span> to{" "}
                  <span className="font-semibold">100+ daily interactions</span>
                </li>
                <li>
                  From{" "}
